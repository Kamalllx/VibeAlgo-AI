# backend/visualization_database/visualizations_stacks_queues.py
#!/usr/bin/env python3
"""
Stack and Queue Algorithm Visualizations
All stack and queue algorithm visualization implementations
"""

import os
from pathlib import Path

def create_stack_queue_visualizations():
    """Create all stack and queue algorithm visualization files"""
    
    base_dir = Path("visualizations/stacks_queues")
    base_dir.mkdir(parents=True, exist_ok=True)
    
    # Next Greater Element
    next_greater_code = '''#!/usr/bin/env python3
"""
...
'''
    ...
    with open(base_dir / "next_greater_element.py", "w") as f:
        f.write(next_greater_code)
    
    print(" Created stack/queue visualization files")
