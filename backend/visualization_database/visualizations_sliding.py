# backend/visualization_database/visualizations_sliding.py
#!/usr/bin/env python3
"""
Sliding Window Algorithm Visualizations
All sliding window algorithm visualization implementations
"""

import os
from pathlib import Path

def create_sliding_window_visualizations():
    """Create all sliding window algorithm visualization files"""
    
    base_dir = Path("visualizations/sliding_window")
    base_dir.mkdir(parents=True, exist_ok=True)
    
    # Maximum Sum Subarray of Size K
    max_sum_subarray_code = '''#!/usr/bin/env python3
"""
...
'''
    ...
    with open(base_dir / "max_sum_subarray.py", "w") as f:
        f.write(max_sum_subarray_code)
    
    print("Created sliding window visualization files")
